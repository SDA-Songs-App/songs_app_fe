    ...
    Content: [
      {
        ...
        category: "Cat 1",
        chorus:
          "Jvn k` rsa m5 c5 t2kdv th6p kv f66 b` k``n, Jvn k` rsa m5 c5 rsdv th6p kv gu11thd`x2\n\n",
        verse_1:
      ...
      },
      {
        ...
        category: "Cat 1",
        chorus:
          "T5eyd` cv l]]x, t5eyd` cv l]]x ku`r. T5eyd` cv l]]x n5 rvydu Ku``r. T5eyd` cv l]]x, t5eyd` cv l]x Ku``r t5eyd` cv l]]xn5 rvy du]pdu\n",
        verse_1:
      ...
      },
      {
        ...
        category: "Cat 1",
        chorus:
          "Nh6kdv jvn gsaa v, gsaa v kv t5eyd`. T0th lsacdv d5tv , jvn d5tv kv f` x2\n",
        verse_1:
...

      {
        ...
        category: "Cat 1",
        chorus:
          "Kv gssy pusny`du l66 C``k, gssy` pusny`du, vjvn in jak xsal d5aal k` gsw. K` gssy pusny`du l66 C``k vjvn nyuth ks gssy.\n",
        verse_1:
  ...
  },
  {
    ...
    Content: [
      ...
      },
      {
        ...
        category: "Cat 1",
        chorus:
          "ቴዎኖ ዶርሺንኬ ማቲ/x2\nቴዎኖ ዶርሺንኬ ማቲ ዓላሜቴንሶ የሱሳት\nጎፌ ዳይኖ ዲሪ ጊዶ ኒንኬ ካይኒ ሮዱዋ\nቃራ ባላ ሳይሳኖሃ ሄገር ሔሾ ቡሳ ዶርሻንኬ አሲኖ የሱሳ\n\n",
        verse_1:
          "አልባንሳን ሺቂንሼና የሱሳና ባርባን\nኪኔራ ወያኖኔሐ ራክኔ ዶዴ (doodhe) ጣን\nይንንሳ ዎይቴ አይሁዴ ሀቤ ባኦ ዶዲትኖ\nየሱሲ ሱታሜና ባርባን ቲሮንኬ ይትኖ\n\n",
        verse_2:
          "ኢሚዲ ቃሌ ሮሳኒ የሱስ ሌዶ ሃራይ ኬሼ\nዶርሻሲ ሚቶ አስራ ሆጌ ግዶ ቡንሼ አማጤ ኬሼ\nቡንሼሲ ቄልቱሲ ዎይቴ የሱሳ ሂሬ ሃሪኖ\nሔሾ አኖኪ ዎጢራ ይሁዱ ባኤ ጋትኖ\n\n",
        verse_3:
          "ማጋኑ ዶዲኖ ማንቺ ጃዋታ ዎልቃ ኡዲሲሴ\nቄሌቴኒ ሳይሳንሳራ አይሁዴ ዲኑይ ጋቲሴ\nማጋኖ አናሲ ሾሊሼ ዳሊላ ላኤ ዶጋሜ\nሳምሶኒ ኢሌ ባኢኖ ዶርሻስ አሲሬ ዓለሜ\n\n",
        verse_4:
          "ሺማ ማና አጉራና ኪሬ ቱንቃኒኢኪ ማኒ\nዓላሜ ዶዳይ ሳኢኖ ማጋኖ ዳዲሊሳኒ\nኢንሳ ጫላ ዲኩላይና ተዎኖ ንንኬ ዶርሺ ማት\nዶድኔ ሔኖሞ ጋሞንኬ አላሜቴንሶ የሱሳት\n\n",
        verse_5: "",
        artist: "አሰፋ ናሮ",
...

       {
        ...
        category: "Cat 1",
        chorus:
          "ካዊ ፉላ ሀሲኔሞ ሚቴ ቃፎ ሌንዴ\nሔሾተ ኡርንሳሃ ቃሌኪ ሄሳንጌ\nጩቡ ጢቢ አማዲዮንኬ ዲህሳትዮንኬ ኦርዱ\nዳፉራሞ ኢኪና ሂኩ ኖያ ዎርቡ\n\n",
        verse_1:
          "ዎንሺቴ ፉሺቴ ሶቂቶሮ አቴ አፎ ኢኪኔሞ\nኑጉሳቴ አልባ ሀላሌክ ኩላቴ ዲዋጅኔሞ\nጮይኔ ዲሳሌሞ ሳልሲሳቶኪሀ ኢኮቶሁራ *2\nሶካኖ አጉርቴ ኮ ዳፉራማ ዶዶቶሁራ\n\n",
        verse_2:
          "አዲንታይ ሞትቻ ሌዶንኬ ኖቶታ ጣኒ ኤጌንሲሲንኬ\nፉሊቶኪ ፉሌ ዲናሆ አማማሞራ ላኦቲንኬ\nዱቹርች እካዎንከ አቴ አፋማ ሜሬሮሆ ሄዱሮ 2*\nማይኖ ዲዱሻዎንኬ ኢካኖንኬላ ቃሊክ ዳይሮ\n\n",
        verse_3:
          "ሬዎቴ ጎጢቾ ጎጣዎኪ ጌዴ አቲ ኢሌያ ጣዊሲ\nቴቾ ያና ሔዴና ጃዋቺሾኤና አንጋኪ ዲሪርሲ\nወዳንዌሎታ ኢሌ ሔዴናንሳ ባሊትዮሬ 2*\nሀን ላዌ ሌሎ ማጫ ኖንሳ ካይን ዳንቂቲዎሬ \n\n",
        verse_4:
          "ማኑ ጋልቲኖሲ አሲርኖ ጊራማዎ ካታሚ ጊዶ\nባአዎሪ ዳፊራ ዱኒታና አት ኢሌኪ ሂንዲዶ\nሁንታዎ ካዮ ዶጌ ቶታዬስታይ ኖንኬና ኩኔ  2*\nማሲቴ ኢሊሽንኬ ወዳኒንኬ ዎጂ ያኖ ሚኔ\n\n",
        verse_5: "",
        artist: "ለገሰ ላንቃሞ",
        language_value: "ሲዳሚኛ መዝሙር",
        displayOrder: 1,
