...
import {View, Text, StyleSheet, TouchableOpacity, TextInput, Button, FlatList, ScrollView, Dimensions, ImageBackground } from 'react-native'
    ...
    return (
      ...
      {/* Modal for language selection */}
          ...
          {selectedSong && (
            ...
            contentContainerStyle={{ paddingBottom: 2 }} // Add padding for the bottom
            showsVerticalScrollIndicator={false} >
              ...
              <ImageBackground
                ...
                >
                {selectedSong.displayOrder === 2 && (
                  <Text style={styles.selectedSongTitle1}>
              ...
              {verses.map((verse, index) => (
                <Text
                  key={index}
                  style={[styles.selectedSongTitle, verse?.style]}
                >
                  {verse?.text}
                </Text>
              ))}
