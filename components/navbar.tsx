...
const getStyles = (isDarkMode: boolean, fontSize: number, fontFamily: string) =>
  StyleSheet.create({
    ...
    songContainer: {
      width: Dimensions.get("window").width, // Slightly narrower for balanced spacing
      justifyContent: "flex-start",
...
const NavbarScreen: FC<NavbarScreenProps> = () => {
  ...
  const songsData = [
    {
      id: "1",
      date: "12/01/2021 04:11 pm",
      title: "Song 1",
      lyrics: "Here I am writing some amazing lyrics While my instrumental is",
      category: "Praise",
      artist: "JOhn",
    },
    {
      ...
      date: "12/01/2021 04:11 pm",
      title: "Simple",
      lyrics: "Fast and effective",
      category: "Worship",
      artist: "JOhn 12",
    },
    {
      id: "3",
      date: "12/01/2021 04:10 pm",
      title: "Musicians",
      lyrics: "Best friend",
      category: "Prayer",
      artist: "Dogn 123",
    },
    {
      ...
      date: "12/01/2021 04:10 pm",
      title: "Best App",
      lyrics: "for great lyrics",
      category: "Praise",
      artist: "Sam",
    },
    {
      id: "5",
      date: "10/01/2021 05:39 pm",
      title: "Song 1",
      lyrics: "Gotta write some inspirational lyrics for this song",
      category: "Worship",
      artist: "Zack",
    },
    {
      id: "6",
      date: "10/01/2021 12:49 am",
      title: "Carry on",
      lyrics: "carry on carry on carry on",
      category: "Prayer",
      artist: "Thomas",
    },
  ...
  */
  ...
  const handleLanguageSelect = (language: string) => {
    ...
    if (selectedLanguageSongs && selectedLanguageSongs.Content.length > 0) {
      const firstSong = selectedLanguageSongs.Content[0];
      setSelectedSong(selectedLanguageSongs.Content[0]);
      ...
      setVerseIndex(0); // Reset to the first verse
    }
    ...
    const results = selectedLanguageSongs.Content.filter((song) => {
      ...
      const matchesText = searchText
        ? song.title.toLowerCase().includes(searchText.toLowerCase()) ||
          ...
          song.id.toString().includes(searchText) // Check if ID matches search text
        : true;
